...
def get_config():
	...
	#--preprocess settings--#
	parser.add_argument('--word_threshold', type=int, default=1, help='threshold to filter out words when building vocabulary set.')
	...
	#---path---#
	parser.add_argument('--pre_train_model', type=str, default='pre_train-200', help='specific pre-trained model name.')
	parser.add_argument('--gan_train_model', type=str, default='gan_train-200', help='specific GAN-trained model name.')
